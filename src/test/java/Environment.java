...
public class Environment {
	...
	public static void main(String[] args) throws Exception {
		...
		chromeDriver.findElement(By.xpath("//*[@id=\"globalNav\"]/nav/div/div[2]/div/div[2]/div[2]/div[6]/a/div/div[2]")).click();
		...
		// wait to get registration confirmation email and goto mail box of temp generated ID
		Thread.sleep(5000);
		chromeDriver.get("https://temp-mail.org/en/");
		...
		// submit photo
		chromeDriver.findElement(By.name("photo")).sendKeys(System.getProperty("user.dir")+"/src/test/resoures/images/Logo.png");
		chromeDriver.quit();
	}
}
